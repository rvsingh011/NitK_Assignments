...
def send_sms(counter_value):
	client = Client("AC4a50b83c946cd1252c957acf2c7bf941", "66f4d5e4a3d13621803766c04aa1fe67")
	if counter_value == 1:
	...
	for i in np.arange(0, detections.shape[2]):
		...
		if confidence > 0.7:
			...
			if CLASSES[idx] == "bus":
				...
				if divmod(elapsed_time.total_seconds(), 60)[1] > 5:
					if counter == 0:
						print("Bus arrived")
						send_sms(0)
						counter = 1
